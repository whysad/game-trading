<table id="dg-order-my" class="easyui-datagrid" style="height:590px"
    data-options="url:'/api/order?word=my',method:'GET',rownumbers:true,pagination:true,fitColumns:true,singleSelect:true">
    <thead>
		<tr>
			<th data-options="field:'sn',width:100">订单流水号</th>
			<th data-options="field:'createTime',width:100">创建时间</th>
			<th data-options="field:'type',width:50">订单类型</th>
